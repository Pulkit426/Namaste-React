...
const ResCard = ({resData}) => {
    ...
    return (
        <div className="res-card">
            <img className="res-image" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + cloudinaryImageId} alt="restaurant-image" />
